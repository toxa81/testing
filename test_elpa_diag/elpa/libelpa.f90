...
call cholesky_complex(na, a, lda, nblk, na, mpi_comm_rows, mpi_comm_cols, .false., success)
...
call invert_trm_complex(na, a, lda, nblk, na, mpi_comm_rows, mpi_comm_cols, .false., success)
...
success = solve_evp_complex(na, nev, a, lda, ev, q, ldq, nblk, na, mpi_comm_rows, mpi_comm_cols)
...
logical success
success = solve_evp_complex_2stage(na, nev, a, lda, ev, q, ldq, nblk, na, mpi_comm_rows, mpi_comm_cols, mpi_comm_all)
